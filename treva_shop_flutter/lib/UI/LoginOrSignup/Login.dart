...
class textFromField extends StatelessWidget {
  ...
  textFromField({this.email, this.icon, this.inputType, this.password, TextEditingController controller, bool autovalidate, FormFieldValidator validator});
